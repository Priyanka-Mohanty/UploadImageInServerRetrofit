package com.example.priyankam.uploadimageinserverretrofit.permission;
...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_PERMISSIONS = "com.android.uploadimage.EXTRA_PERMISSIONS";
