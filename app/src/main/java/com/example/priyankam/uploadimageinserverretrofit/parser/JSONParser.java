package com.example.priyankam.uploadimageinserverretrofit.parser;
...
public class JSONParser {
     ...
     */
    private static final String URL_UPLOAD_IMAGE = "http://10.1.1.206/Projects/php_upload_okhttp/upload.php";
